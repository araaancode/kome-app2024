            ...
            <div className="card mx-auto w-full max-w-5xl shadow-2xl">
                <div className="grid md:grid-cols-2 grid-cols-1 bg-base-100 rounded-xl">
                    ...
                    <div className="flex flex-col bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 w-full max-w-md m-auto">
                        <div className="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">ثبت نام در پنل مدیریت</div>
                            ...
                            <form onSubmit={(e) => submitForm(e)}>
                                ...
                                <div className="flex w-full mt-5">
                                    <button type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-800 hover:bg-blue-900 rounded py-2 w-full transition duration-150 ease-in">
                                        <span className="mr-2 uppercase">ثبت نام</span>
                                    </button>
                                </div>
                            </form>
                        </div>
                        <div className='text-center mt-4'>حساب دارید؟ <a href="/admins/login" className='no-underline hover:text-blue-900'><button className="inline-block hover:cursor-pointer transition duration-200"> ورود</button></a></div>
