...
const SingleOwnerTicket = () => {
    let { ownerId, stId } = useParams();
    ...
    const handleAddComment = () => {
        ...
        axios.put(`/api/admins/owners/${ownerId}/support-tickets/${stId}/add-comment`, { comment: newComment }, {
            headers: {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/admins/owners/${ownerId}/support-tickets/${stId}`, { headers: { authorization: AuthStr } })
            .then(response => {
...
export default SingleOwnerTicket